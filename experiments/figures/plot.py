...
x0 = [13.5, 41.3, 15.7, 3.1,    14.5, 41.6,    99.2, 95.5, 21.0,              15.9]
x1 = [16.9, 79.4, 17.3, 3.1,    16.1, 52.9,    102.4, 1847.9, 32.0,           18.5]
x2 = [49.3, 0, 23.9, 3.1,       19.3, 104.6,   107.6,    278.0,               24.3]

z0 = [17.7, 79.4, 26.1, 3.1,   22.3, 91.2,     104.0, 164.9, 44.4,        16.1]
z1 = [24.2, 432.4, 31.2, 3.1,  25.7, 150.7,    105.5, 2309.8, 89.6,       18.5]
z2 = [132.1, 0, 55.2, 3.2,     33.0, 633.2,    107.1,    1543.4,          24.5]

y0 = [33.5, 169.3, 38.1, 11.1   , 35.0, 182.6,   388.0, 271.0, 39.8,            12.9]
y1 = [47.0, 595.1, 45.6, 13.8   , 40.2, 263.7,   390.8, 2746.6, 85.0,           15.2]
