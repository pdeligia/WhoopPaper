...
Using the race freedom guarantees that \whoop provides, we managed to significantly accelerate \corral in the majority of the cases. We noticed speedups between 1.5--20x.
