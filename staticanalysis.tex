...
Watchdog summarisation is based on our lockset and watchdog race checking instrumentation and uses the Houdini~\cite{flanagan2001houdini} invariant inference algorithm (available in Boogie) to automatically compute summaries from a pool of automatically generated candidate invariants.
