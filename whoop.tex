...
\ADComment{Explain why the shared variables are gone.}


\medskip\noindent\textbf{Sequentialisation }
\ADComment{Show what we actually check.}


\ADComment{Now state the theoretical result, paying attention to termination.}
